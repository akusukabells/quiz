                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <form method="post" action="../API/level.php">
                                            <button class="btn btn-primary btn-block btn-round" name="goaddlevel" style="margin-top:0px;width:100px !important;float:right !important;">Add Level</button>
                                        </form>
                                    </div>
                                    <table class="table table-hover" style="margin-left:1%">
                                        ...
                                        <tbody>
                                            ...
                                            $getData = $database->getReference("Level")->getValue();
                                            $no = 1;
                                            if ($getData > 0) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form method="post" action="../API/level.php">
                                                                ...
                                                                <button type="submit" class="btn btn-danger" name="delete" value="<?php echo $row['idlevel']; ?>">Delete</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                            <?php
