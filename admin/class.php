                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <form method="post" action="../API/class.php">
                                            <button class="btn btn-primary btn-block btn-round" name="goaddclass" style="margin-top:0px;width:100px !important;float:right !important;">Add Class</button>
                                        </form>
                                    </div>
                                    <table class="table table-hover" style="margin-left:1%">
                                        ...
                                        <tbody>
                                            ...
                                            $getData = $database->getReference("Class")->getValue();
                                            $no = 1;
                                            if ($getData > 0) {
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form method="post" action="../API/class.php">
                                                                <button type="submit" class="btn btn-success" name="edit" value="<?php echo $row['idclass']; ?>">Edit</button>
                                                                <button type="submit" class="btn btn-danger" name="delete" value="<?php echo $row['idclass']; ?>">Delete</button>
                                                            </form>
                                                        </td>
                                                    </tr>
                                            <?php
