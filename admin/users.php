                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <form method="post" action="../API/users.php">
                                            <button class="btn btn-primary btn-block btn-round" name="goadd" style="margin-top:0px;width:140px !important;float:right !important;">Add Users</button>
                                        </form>
                                    </div>
                                    <table class="table table-hover" style="margin-left:1%">
                                        ...
                                        <tbody>
                                            ...
                                            $getData = $database->getReference("Users")->orderByChild("role")->getValue();
                                            $no = 1;
                                            rsort($getData);
                                            if ($getData > 0) {
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form method="post" action="../API/users.php">
                                                                <button type="submit" class="btn btn-success" name="goedit" value="<?php echo $row['nis']; ?>">Edit</button>
