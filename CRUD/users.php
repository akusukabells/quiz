                        ...
                        <div class="card" style="min-height:400px;">
                            <div class="card-header">
                                ...
                                if (!empty($_SESSION['edit'])) {
                                    $getData = $database->getReference("Users/" . $_SESSION['edit'])->getValue();
                                ?>
                                    <form method="post" action="../API/users.php">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="name" placeholder="Student Name" value="<?php echo $getData['name']; ?>">
                                        </div>
                                        <div class=" form-group">
                                        ...
                                        <button class=" btn btn-primary btn-block btn-round" name="adddata" style="margin-top:50px;float:right !important;">Save</button>
